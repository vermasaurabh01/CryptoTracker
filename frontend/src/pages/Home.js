            ...
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  Keep track of your profits, losses and portfolio valution
                ...
                <p className="mt-4 text-gray-600">
                  Login to enjoy amazing tracker
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      A decent crypto portfolio management app should provide
                      real-time data (such as crypto prices). 
                      In fact, this is one of the most important advantages 
                      of these tools compared to manual tracking.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Automatic Updates</p>
                    <p className="mt-4">
                    The tracker should automatically update your portfolio
                     with the latest data. So, there would be no need for
                      manual input, and it’ll save you a lot of time.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Diversification Analysis</p>
                    <p className="mt-4">
                      Best crypto portfolio trackers analyze your portfolio’s 
                      diversification. They provide visual insights like graphs 
